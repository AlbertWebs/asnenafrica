  ...
  <tr>
    <td style="padding:28px 32px;">
      ...
      <p style="margin:0 0 20px;font-family:Arial,sans-serif;font-size:15px;line-height:1.6;color:#4a4540;">
        Your registration for the Inclusive by Design Masterclass representing <strong>{{ $registration->school_name }}</strong> has been received and is <strong>being processed</strong>. We will follow up with payment instructions once your application is reviewed.
      </p>
