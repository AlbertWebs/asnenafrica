...
class PaymentConfirmedParticipant extends Mailable
{
    ...
    {
        return new Envelope(
            subject: 'Registration Confirmed — Inclusive by Design ('.$this->registration->reference.')',
            replyTo: [
                new Address(
    ...
    {
        return new Content(
            view: 'emails.payment-confirmed-participant',
        );
    }
